...
public class WriterBlogAdapter extends RecyclerView.Adapter<WriterBlogAdapter.ImagecategoryViewHolder> {
    ...
    public WriterBlogAdapter(Activity curr_activity, Context curr_context, ArrayList<Blog> arrappliedjob, String writerName) {
