...
public class BookmarksBlogAdapter extends RecyclerView.Adapter<BookmarksBlogAdapter.ImagecategoryViewHolder> {
    private Context curr_context;
    private Activity curr_activity;
    private String uName,bTitle;
    List<BookMark_List_Data> arrappliedjob;
    SharedPreferences preferences;
    User userData;
    private OUD_Viewmodel oud_Viewmodel;
    private String username;
    private BookMark_List_Data blog;
    //boolean isAll = false;
    MyWorldActionListener myWorldActionListener;

    public BookmarksBlogAdapter(Activity curr_activity, Context curr_context, List<BookMark_List_Data> arrappliedjob, MyWorldActionListener myWorldActionListener) {
    ...
    public void onBindViewHolder(final ImagecategoryViewHolder holder, final int position) {
        ...
        final BookMark_List_Data show = arrappliedjob.get(position);
    ...
    public class ImagecategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImagecategoryViewHolder(View view) {
            ...
            TVFollow.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    BookMark_List_Data blog = arrappliedjob.get(getAdapterPosition());
            ...
            list_image.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    BookMark_List_Data show = arrappliedjob.get(getAdapterPosition());
            ...
            this.IVBookmarked.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (blog.getIsBookmarked()) {
                        ...
                        oud_Viewmodel.updateBookmark(blog,false);
                        IVBookmarked.setImageResource(R.drawable.bookmarkblue);
                        //getBMStat();
                    } else {
                        oud_Viewmodel.updateBookmark(blog,true);
                        //fcmNotify("bookmark");
    ...
    public void addItems(List<BookMark_List_Data> arrappliedjob)
    {
        this.arrappliedjob=arrappliedjob;
