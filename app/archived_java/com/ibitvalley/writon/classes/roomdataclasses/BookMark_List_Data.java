...
@Entity(tableName = "BookMarkList", indices = {@Index(value = {"blogId"},
        unique = true)})
public class BookMark_List_Data implements Serializable, Parcelable
{
    @PrimaryKey(autoGenerate = true)
    @NonNull
    private long id;

    public BookMark_List_Data(Post_List_Data post_list_data) {

        this.id = post_list_data.getId();
        this.userId = post_list_data.getUserId();
        this.title = post_list_data.getTitle();
        this.category = post_list_data.getCategory();
        this.subCat = post_list_data.getSubCat();
        this.longDescription = post_list_data.getLongDescription();
        this.shortDescription = post_list_data.getShortDescription();
        this.creationDate = post_list_data.getCreationDate();
        this.language = post_list_data.getLanguage();
        this.blogId = post_list_data.getBlogId();
        this.userName = post_list_data.getUserName();
        this.userImage = post_list_data.getUserImage();
        this.quoteofDay = post_list_data.getQuoteofDay();
        this.introducation = post_list_data.getIntroducation();
        this.workingOn = post_list_data.getWorkingOn();
        this.userCreationDate = post_list_data.getUserCreationDate();
        this.updatedAt = post_list_data.getUpdatedAt();
        this.isRated = post_list_data.getIsRated();
        this.isBookmarked = post_list_data.getIsBookmarked();
        this.isFollowed = post_list_data.getIsFollowed();
        this.bookMarkedCount = post_list_data.getBookMarkedCount();
        this.viewCount = post_list_data.getViewCount();
        this.ratingCount = post_list_data.getRatingCount();
        this.commentsCount = post_list_data.getCommentsCount();
        this.userFollowersCount = post_list_data.getUserFollowersCount();
        this.userFollowingCount = post_list_data.getUserFollowingCount();
        this.total = post_list_data.getTotal();
    }

    public BookMark_List_Data(PersonalPost_List_Data post_list_data) {
    ...
    public BookMark_List_Data(MyWorldModel post_list_data) {

        this.id = Long.parseLong( post_list_data.getId() );
        this.userId = post_list_data.getUserId();
        this.title = post_list_data.getTitle();
        this.blogId = post_list_data.getBlogId();
        this.userName = post_list_data.getUserName();
...
//    private Integer bookMarkedCount;
    ...
    protected BookMark_List_Data(Parcel in) {
