...
//
//
//        latestLatestBlogAdapter = new LatestBlogAdapter(getActivity(), getContext(), ShowBlogIngo.blogArrayList2, this,false);
...
//                            ArrayList<Post_List_Data> latest_post = new Gson().fromJson(arrMainCategoryJson.toString(), type);
//                            //loadData(arrMainCat);
...
//
//
//    private void displayLatestPost(ArrayList<Post_List_Data> latestBlog){
//        latestLatestBlogAdapter = new LatestBlogAdapter(getActivity(), getContext(), latestBlog, this,false);
//        //Adapter set to recyclerView
//        //recyclerViewLatest.setAdapter(latestLatestBlogAdapter);
//        latestLatestBlogAdapter.notifyDataSetChanged();
//    }
...
//        topRatedAdapter = new TopRatedAdapter(getActivity(), getContext(), trendingBlog,"Trending");
