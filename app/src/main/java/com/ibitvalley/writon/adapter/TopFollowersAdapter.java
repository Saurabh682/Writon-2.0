...
public class TopFollowersAdapter extends RecyclerView.Adapter<TopFollowersAdapter.ImagecategoryViewHolder> {
    ...
    @Override
    public TopFollowersAdapter.ImagecategoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.blog_card, parent, false);
        return new TopFollowersAdapter.ImagecategoryViewHolder(itemView);
    }
...
//        }
    ...
    public class ImagecategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImagecategoryViewHolder(View view) {
            ...
            this.TVHeader1.setText("TOP FOLLOWERS");
