...
public class TopRatedAdapter extends RecyclerView.Adapter<TopRatedAdapter.ImagecategoryViewHolder> {
    ...
    @Override
    public TopRatedAdapter.ImagecategoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.blog_card, parent, false);
        return new TopRatedAdapter.ImagecategoryViewHolder(itemView);
    }
...
//        }
    ...
    public class ImagecategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImagecategoryViewHolder(View view) {
            ...
            this.TVHeader1.setText("TOP RATED");
