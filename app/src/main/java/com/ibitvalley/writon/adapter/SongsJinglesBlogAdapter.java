...
// */
//
//public class SongsJinglesBlogAdapter extends RecyclerView.Adapter<SongsJinglesBlogAdapter.ImagecategoryViewHolder> {
//    private Context curr_context;
//    private Activity curr_activity;
//    ArrayList<Blog> arrappliedjob;
//    SharedPreferences preferences;
//    Typeface tf;
//    public SongsJinglesBlogAdapter(Activity curr_activity, Context curr_context, ArrayList<Blog> arrappliedjob) {
...
//            blogType.setText("Songs/ Jingles");
...
//                    blogprofile.putExtra("boxTitle", "Songs/ Jingles");
//                    curr_context.startActivity(blogprofile);
//                }
//            });
