...
//
//public class AllBlogActivity extends BaseActivity {
//
//
...
//
//        if(pageCount == 1) {
//            latestLatestBlogAdapter = new LatestBlogAdapter(curr_activity, curr_context, latestBlog);
...
//
//
//    ArrayList<Post_List_Data> trendingList, trendingNewList;
//
...
//                        JSONObject jsonResponseMain = jsonResponse.getJSONObject("data");
//                        JSONArray arrMainCategoryJson = jsonResponseMain.optJSONArray("data");
//                        Type type = new TypeToken<ArrayList<Post_List_Data>>() {}.getType();
//                        ArrayList<Post_List_Data> trending_post = new Gson().fromJson(arrMainCategoryJson.toString(), type);
//
//                        trendingNewList.addAll(trending_post);
//
...
//
//
////        RetroFitClient trendingPost = ServiceGenerator.getRetrofit().create(RetroFitClient.class);
////        trendingPost.getTrendingPost(  )
//
//    }
//
//
//    private void displayLTrendingPost(ArrayList<Post_List_Data> trendingBlog){
////        if(pageCount == 1) {
...
//                            Post_List_Data objBlog = trending_post.get(lIncr);
...
//    }
//
//    private void displayTopFollowersPost(ArrayList<Post_List_Data> trendingBlog){
//
//        //Adapter set to recyclerView
//        if(pageCount == 1) {
...
//    }
//
//    private void displayTopRatedPost(ArrayList<Post_List_Data> trendingBlog){
//
//        if(pageCount == 1) {
//            topRatedAdapter = new TopRatedAdapter(curr_activity, curr_context, trendingBlog,"Trending");
//            LinearLayoutManager latestLayoutManager = new LinearLayoutManager(curr_context);
//            latestLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
//            recyclerViewDataShow.getRecycledViewPool().clear();
//            recyclerViewDataShow.setHasFixedSize(true);
