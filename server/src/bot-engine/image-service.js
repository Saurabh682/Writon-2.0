const CATEGORY_IMAGE_COLLECTIONS = {
  ...
  'Sports': [
    ...
    'https://images.unsplash.com/photo-1531415074868-036b1c57e329?w=1200&auto=format&fit=crop&q=80',
  ...
  'Journalism': [
    ...
    'https://images.unsplash.com/photo-1566378246598-5b11a0d486cc?w=1200&auto=format&fit=crop&q=80'
  ]
};
...
export const DOMAIN_PRODUCT_IMAGES = {
  // Cars & Mobility
  'EVs & Battery Tech': [
    'https://images.unsplash.com/photo-1536700503339-1e4b06520771?w=1200&auto=format&fit=crop&q=80', // Modern electric car
    'https://images.unsplash.com/photo-1563720223185-11003d516935?w=1200&auto=format&fit=crop&q=80', // Electric vehicle charging station
    'https://images.unsplash.com/photo-1617788138017-80ad40651399?w=1200&auto=format&fit=crop&q=80'  // Modern EV interior cockpit & dashboard
  ],
  'Performance ICE Cars': [
    'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=1200&auto=format&fit=crop&q=80', // Sports car track
    'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=1200&auto=format&fit=crop&q=80', // German performance sedan
    'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=1200&auto=format&fit=crop&q=80'  // Performance exhaust / apex
  ],
  'Urban Commuter Bikes & EV 2W': [
    'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=1200&auto=format&fit=crop&q=80', // Urban motorcycle
    'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=1200&auto=format&fit=crop&q=80', // Electric scooter city
    'https://images.unsplash.com/photo-1591637333184-19aa84b3e01f?w=1200&auto=format&fit=crop&q=80'  // Modern street bike
  ],
  '4x4 Off-Roaders & Expedition SUVs': [
    'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=1200&auto=format&fit=crop&q=80', // 4x4 trail
    'https://images.unsplash.com/photo-1506015391300-4802dc74de2e?w=1200&auto=format&fit=crop&q=80', // Mountain expedition SUV
    'https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?w=1200&auto=format&fit=crop&q=80'  // Mud trail vehicle
  ],

  // Tech & Electronics
  'Flagship Smartphones': [
    'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=1200&auto=format&fit=crop&q=80', // Modern smartphone
    'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=1200&auto=format&fit=crop&q=80', // Smartphone camera bump
    'https://images.unsplash.com/photo-1580910051074-3eb694886505?w=1200&auto=format&fit=crop&q=80'  // Titanium frame phone
  ],
  'Budget & Mid-Range Mobiles': [
    'https://images.unsplash.com/photo-1567581935884-3349723552ca?w=1200&auto=format&fit=crop&q=80', // Everyday smartphone
    'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=1200&auto=format&fit=crop&q=80'   // Clean minimalist phone
  ],
  'Laptops, Silicon & Chips': [
    'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=1200&auto=format&fit=crop&q=80', // Sleek laptop keyboard
    'https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?w=1200&auto=format&fit=crop&q=80', // Silicon wafer / processor
    'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=1200&auto=format&fit=crop&q=80'  // Premium ultrabook
  ],
  'Headphones, IEMs & Audio Gear': [
    'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1200&auto=format&fit=crop&q=80', // Studio headphones
    'https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=1200&auto=format&fit=crop&q=80', // ANC over-ear cans
    'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=1200&auto=format&fit=crop&q=80'  // IEMs & wireless earbuds
  ],
  'Wearables & Health Hardware': [
    'https://images.unsplash.com/photo-1508685096489-7aacd43bd3b1?w=1200&auto=format&fit=crop&q=80', // Modern smartwatch
    'https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=1200&auto=format&fit=crop&q=80', // Biometrics tracker
    'https://images.unsplash.com/photo-1510017803434-a899398421b3?w=1200&auto=format&fit=crop&q=80'  // Smart band on wrist
  ],

  // Anime, Series & Cinema
  'Shonen Anime & Sakuga Animation': [
    'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=1200&auto=format&fit=crop&q=80', // Anime art neon
    'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=1200&auto=format&fit=crop&q=80'  // Japanese animation style
  ],
  'Seinen & Psychological Anime': [
    'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=1200&auto=format&fit=crop&q=80', // Melancholic Tokyo dusk
    'https://images.unsplash.com/photo-1534447677768-be436bb09401?w=1200&auto=format&fit=crop&q=80'  // Atmospheric watercolor frame
  ],
  'Prestige TV & Streaming Series': [
    'https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?w=1200&auto=format&fit=crop&q=80', // Cinematic screen
    'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1200&auto=format&fit=crop&q=80'  // Theater hall / drama
  ],
  'Hollywood Blockbusters & Sci-Fi Cinema': [
    'https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=1200&auto=format&fit=crop&q=80', // Sci-fi cinematic lights
    'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=1200&auto=format&fit=crop&q=80'  // Film projector
  ],
  'Regional & World Cinema': [
    'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=1200&auto=format&fit=crop&q=80', // Film reel / arthouse
    'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=1200&auto=format&fit=crop&q=80'  // Classic camera clapboard
  ],

  // Gear & Hardware
  'Gaming Handhelds & Consoles': [
    'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=1200&auto=format&fit=crop&q=80', // Retro gaming tech
    'https://images.unsplash.com/photo-1600080972464-8e5f35f63d08?w=1200&auto=format&fit=crop&q=80', // Handheld gaming screen
    'https://images.unsplash.com/photo-1612287233207-63a23a886b72?w=1200&auto=format&fit=crop&q=80'  // Console controller
  ],
  'Cameras, Prime Lenses & Optics': [
    'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=1200&auto=format&fit=crop&q=80', // Camera lens aperture
    'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=1200&auto=format&fit=crop&q=80', // Mirrorless metal body
    'https://images.unsplash.com/photo-1512790182412-b19e6d62bc39?w=1200&auto=format&fit=crop&q=80'  // 50mm Prime lens glass
  ],
  'Custom Mechanical Keyboards': [
    'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=1200&auto=format&fit=crop&q=80', // Mechanical keyboard macro
    'https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?w=1200&auto=format&fit=crop&q=80', // PBT keycaps & coiled cable
    'https://images.unsplash.com/photo-1595225476474-87563907a212?w=1200&auto=format&fit=crop&q=80'  // Custom aluminum keyboard
  ],
  'Smart Home & Matter Hardware': [
    'https://images.unsplash.com/photo-1558002038-1055907df827?w=1200&auto=format&fit=crop&q=80', // Smart thermostat / sensor
    'https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=1200&auto=format&fit=crop&q=80'  // Modern smart home lighting
  ],
  'Coffee Gear & Espresso Tech': [
    'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=1200&auto=format&fit=crop&q=80', // Espresso portafilter
    'https://images.unsplash.com/photo-1517256064527-09c73fc73e38?w=1200&auto=format&fit=crop&q=80', // Espresso machine steam
    'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=1200&auto=format&fit=crop&q=80'  // Coffee grinder & beans
  ],
  'EDC Gear & Rugged Tools': [
    'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=1200&auto=format&fit=crop&q=80', // Multi-tool & blade steel
    'https://images.unsplash.com/photo-1544816155-12df9643f363?w=1200&auto=format&fit=crop&q=80'   // Rugged pocket gear & pack
  ]
};

export function getProductCoverImage(domain, productName = '') {
  const images = DOMAIN_PRODUCT_IMAGES[domain] || DOMAIN_PRODUCT_IMAGES['Flagship Smartphones'];
  const randomIndex = Math.floor(Math.random() * images.length);
  return images[randomIndex];
}
